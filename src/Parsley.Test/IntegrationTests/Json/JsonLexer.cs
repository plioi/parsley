namespace Parsley.Test.IntegrationTests.Json
{
    public class JsonLexer : Lexer
    {
        ...
        private static readonly TokenKind Whitespace = new TokenKind("whitespace", @"\s+", skippable: true);
        ...
        public static readonly TokenKind Quotation = new TokenKind("string", @"
            # Open quote:
            ""
        ...
        public static readonly TokenKind Number = new TokenKind("number", @"
