...
class ReadOnlySpanExtensionsTests
{
    ...
    public void CanTrackCurrentPosition()
    {
        ...
        empty.Advance(ref position, 0);
        position.ShouldBe(new Position(0));
        ...
        position.ShouldBe(new Position(5));

        list = snapshot;
        position = new(0);
        list.Advance(ref position, 6);
        position.ShouldBe(new Position(6));


        list = snapshot;
        position = new(0);
        list.Advance(ref position, 7);
        position.ShouldBe(new Position(7));

        list = snapshot;
        position = new(0);
        list.Advance(ref position, 12);
        position.ShouldBe(new Position(12));

        list = snapshot;
        position = new(0);
        list.Advance(ref position, 13);
        position.ShouldBe(new Position(13));


        list = snapshot;
        position = new(0);
        list.Advance(ref position, 14);
        position.ShouldBe(new Position(14));

        list = snapshot;
        position = new(0);
        list.Advance(ref position, 19);
        position.ShouldBe(new Position(19));

        list = snapshot;
        position = new(0);
        list.Advance(ref position, 20);
        position.ShouldBe(new Position(20));


        list = snapshot;
        position = new(0);
        list.Advance(ref position, 21);
        position.ShouldBe(new Position(21));
