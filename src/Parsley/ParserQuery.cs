...
namespace Parsley
{
    public static class ParserQuery
    {
        ...
        /// </summary>
        public static IParser<TResult> Select<TInterim, TResult>(this IParser<TInterim> parser, Expression<Func<TInterim, TResult>> resultContinuation)
        {
        ...
        /// </summary>
        public static IParser<TResult> SelectMany<T1, T2, TResult>(this IParser<T1> parser, Expression<Func<T1, IParser<T2>>> value1ToParser2Continuation, Expression<Func<T1, T2, TResult>> resultContinuation)
        {
